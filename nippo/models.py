...
class NippoModel(models.Model):
    ...
    # 画像追加　開始
    img = models.ImageField(upload_to="image",verbose_name="イメージ画像",null=True,blank=True) #追加
    #img = models.FileField(upload_to="image",verbose_name="イメージ画像",null=True,blank=True) #追加
    ...
    slug = models.SlugField(max_length=20, unique=True, default=slug_maker, verbose_name="スラッグ")
